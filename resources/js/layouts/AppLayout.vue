...
const navigation = [
    { name: 'Home', href: index.url(), icon: HomeIcon, current: true },
    { name: 'Following', href: '#', icon: InboxStackIcon, current: false },
    { name: 'Global', href: '#', icon: GlobeAsiaAustraliaIcon, current: false },
...
<template>
    <div>
        ...
        <div class="lg:pl-72">
            ...
            <main class="py-10">
                <div class="px-4 sm:px-6 lg:px-8 flex w-full justify-center">
                    <slot />
                </div>
            </main>
        </div>
